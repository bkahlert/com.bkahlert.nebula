package com.bkahlert.nebula.gallery.demoSuits.instruction.note;
...
import com.bkahlert.devel.nebula.widgets.explanation.note.NoteComposite;
...
public class NoteCompositeDemo extends AbstractDemo {
	protected NoteComposite createNoteComposite(Composite parent, int iconId,
		...
		NoteComposite noteComposite = new NoteComposite(parent, SWT.BORDER) {
			...
			public void createContent(final Composite parent) {
				...
				Button button = new Button(this.illustratedComposite, SWT.PUSH);
	...
	public void createDemo(Composite parent) {
		...
		for (int i = 0; i < iconIds.length; i++) {
			...
			NoteComposite noteComposite = this.createNoteComposite(parent,
