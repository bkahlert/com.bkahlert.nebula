package com.bkahlert.nebula.utils.history;
...
public class History<T> implements IHistory<T> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#pos()
	 */
	@Override
	public int pos() {
		return this.pos;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#size()
	 */
	@Override
	public int size() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#hasPrev()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#hasNext()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#get()
	 */
	@Override
	public T get() {
		if (this.pos == -1) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#add(T)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#back()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bkahlert.nebula.utils.history.IHistory#forward()
	 */
	@Override
