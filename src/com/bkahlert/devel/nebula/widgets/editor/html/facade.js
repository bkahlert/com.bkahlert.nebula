...
(function($) {
    ...
    $.extend(com.bkahlert.devel.nebula.editor, {
        ...
        onready : function(e) {
            ...
            if (!internal) {
                window["modified"] = function(content) {
                    console.log("change event: " + content);
                };
        ...
        setSource : function(html, callback) {
            $('textarea').val(html);
            var editor = CKEDITOR.instances.editor1;
...
function testFunction() {
    com.bkahlert.devel.nebula.editor.setEnabled(true);
}