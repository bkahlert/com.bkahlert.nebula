package com.bkahlert.devel.nebula.widgets.chatControl;
...
import com.bkahlert.devel.nebula.widgets.chatControl.parts.ChatDisplay;
import com.bkahlert.devel.nebula.widgets.chatControl.parts.ChatInput;
...
public class ChatControl extends Composite {
	...
	public ChatControl(Composite parent, int style,
		...
		// ChatDisplay
		this.chatDisplay = new ChatDisplay(this.sashForm, chatDisplayStyle,
				displayBackgroundColor);
		this.chatDisplay.setAlwaysShowScrollBars(true);
		this.chatDisplay.addChatDisplayListener(this.chatDisplayListener);

		// ChatInput
		this.chatInput = new ChatInput(this.sashForm, chatInputStyle);
		...
		this.addListener(SWT.Resize, new Listener() {
			...
			public void handleEvent(Event event) {
				...
				int lineHeight = (int) Math.round(ChatControl.this.chatInput
						.getFont().getFontData()[0].getHeight() * 1.4);
				...
				ChatControl.this.sashForm.setWeights(new int[] {
						newChatDisplayHeight, chatInputHeight });
			}
		});
